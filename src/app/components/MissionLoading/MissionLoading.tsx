...
const MissionLoading = () => {
    return (
        <div>
            <div className='flex flex-col my-10 md:my-11 px-8 md:px-32 justify-center items-center gap-5'>
                ...
                <h1 className='text-center text-3xl text-basic_purple font-montserrat font-extrabold'>Loading Desenvolvimento Jr</h1>
                <p className='text-center text-xl pl-4 pr-4 font-medium'>
